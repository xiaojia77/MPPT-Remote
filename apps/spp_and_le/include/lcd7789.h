...
void Mppt_Ble_BatchSet_Menu(void);
    ...
    //放电参数设置
    void Mppt_Dischar_Set_Display(void);
...
void Mppt_Ble_con_Select_Menu_Operation(uint8_t key);
    ...
    void Mppt_Ble_con_Menu_Operation(uint8_t key);
        ...
        void Mppt_Ble_Set_Operation(uint8_t key);
            ...
            void Mppt_Info_Display(void); // MPPT参数配置
...
static Menu_Tab_t const Menu_Tab[]=
{
    ...
    {BLE_BATCHSET_MENU,MAIN_MENU,5,Mppt_Ble_BatchSet_Menu_Operation,Mppt_Ble_BatchSet_Menu}, // 批量设置菜单
        ...
        {BL_ATCON_SET_MENU,BLE_BATCHSET_MENU,8,Mppt_Main_Menu_Select,Mppt_Ble_AutoConnect_set_menu},
    ...
    {VERSION_CHECK_MENU,MAIN_MENU,NULL,Mppt_Main_Menu_Select,Mppt_Version_Info_menu},

    {MPPT_VERSION_SELECT_MENU,MAIN_MENU,1,Mppt_Main_Menu_Select,Mppt_Version_Select_Menu},
