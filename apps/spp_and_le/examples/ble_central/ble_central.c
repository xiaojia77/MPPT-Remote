...
static const sm_cfg_t cetl_sm_init_config = {
    .master_security_auto_req = 1,  /*主机主动发起加密*/
    .master_set_wait_security = 1, /*主机等待加密完成再执行profile搜索*/
...
static scan_conn_cfg_t cetl_client_scan_cfg;  // gatt client 配置 
...
{
#if CETL_TEST_WRITE_SEND_DATA   //连接上自动发数据
    static u32 count = 0;
