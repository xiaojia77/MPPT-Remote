...
#error "need define TCFG_LOWPOWER_LOWPOWER_SEL  0 !!!!!!"
    ...
    log_i("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
    /********    LVD挡位(对应电压值) **************************************************
     * 632: 0(1.55V),1(1.70V),2(1.85V),3(2.00V),4(2.15V),5(2.30V),6(2.45V),7(2.60V)
     * 635: 0(1.90V),1(2.00V),2(2.10V),3(2.20V),4(2.30V),5(2.40V),6(2.50V),7(2.60V)
     * 636: 0(<1.5V),1(1.90V),2(2.00V),3(2.10V),4(2.20V),5(2.30V),6(2.40V),7(2.50V)
     * 637: 0(1.80V),1(1.90V),2(2.00V),3(2.10V),4(2.20V),5(2.30V),6(2.40V),7(2.50V)
     * 638: 0(1.80V),1(1.90V),2(2.00V),3(2.10V),4(2.20V),5(2.30V),6(2.40V),7(2.50V)
     *******************************************************************************/
    ...
    VLVD_SEL(2); //设置第2挡，根据需求，选择合适档位
    P33_VLVD_EN(1);  //开启LVD低电复位功能
    /* P33_VLVD_EN(0); //关闭LVD低电复位功能  */
    printf("GET_LVD_LEV:%d", GET_LVD_LEV());
    printf("GET_LVD_EN:%d", GET_LVD_EN());
    clock_dump();
